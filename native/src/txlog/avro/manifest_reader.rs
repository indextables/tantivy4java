...
fn avro_value_to_file_entry(value: &Value) -> Result<FileEntry> {
    ...
    let add = AddAction {
        ...
        delete_opstamp: get_optional_long(&field_map, "deleteOpstamp"),
        split_tags: get_optional_string_array(&field_map, "splitTags"),
        ...
        time_range_start: get_optional_string(&field_map, "timeRangeStart"),
        time_range_end: get_optional_string(&field_map, "timeRangeEnd"),
