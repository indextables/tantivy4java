...
use crate::split_query::{get_split_schema, convert_split_query_to_json};
...
use quickwit_storage::{Storage, ByteRangeCache, STORAGE_METRICS};
...
fn get_split_size_hint(_split_uri: &str) -> Option<usize> {
